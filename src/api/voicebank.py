...
def get_voicebank_info(voicebank: Union[str, Path]) -> Dict[str, Any]:
    ...
    if isinstance(voicebank, str) and not path.exists() and "/" not in voicebank and "\\" not in voicebank:
        ...
        if manifest_entry:
            result = {
                ...
                "language_details": manifest_entry.get("language_details", {}),
                ...
                "synthesis_control_defaults": manifest_entry.get(
                    ...
                    {"airiness": 0.0, "intensity": 0.5, "clarity": 100.0, "gender": 0.0},
                ),
    ...
    result = {
        ...
        "languages": languages,
        "language_details": manifest_metadata.get("language_details", {}),
